...
namespace ShmupBossEditor
{
    ...
    public class CurveMoverEditor : EditorTools
    {
        ...
        private void DrawControlPoints()
        {
            ...
            {
                var fmh_80_77_638599332615748393 = Quaternion.identity; Vector2 pos = Handles.FreeMoveHandle(path.ControlPoints[i], handleSize.floatValue, Vector2.zero, DoubleCircleHandleCap);
